...
<script type="text/javascript">window.addEventListener('DOMContentLoaded',function(){var v=archive_analytics.values;v.service='wb';v.server_name='wwwb-app217.us.archive.org';v.server_ms=1485;archive_analytics.send_pageview({});});</script>
...
<iframe id="playback" src="https://web.archive.org/web/20071030163530if_/http://www.wildlife-pal.org/cp/Scripts/PHP/Guestbook/readme.txt" frameborder="0" style="flex:1 0">
</iframe>
<script>
