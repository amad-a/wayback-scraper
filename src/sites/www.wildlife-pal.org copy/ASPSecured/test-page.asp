...
<html lang="en">
  <head>
    ...
    */
    ...
    <!-- is_embedded: False; context: <wayback.replay.core.ReplayContext object at 0x7fa5b4036670> -->
    <!-- navbar https://archive.org/web/navbar.php 0.10848s -->
    <!-- navbar script -->
    <script src="//archive.org/includes/athena.js?v=e9d35115" type="text/javascript"></script>
    <script src="//archive.org/includes/apollo.js?v=e9d35115" type="text/javascript"></script>
    <script src="//archive.org/components/npm/lit/polyfill-support.js?v=e9d35115" type="text/javascript"></script>
    <script src="//archive.org/components/npm/@webcomponents/webcomponentsjs/webcomponents-bundle.js?v=e9d35115" type="text/javascript"></script>
    <script src="//archive.org/includes/build/js/ia-topnav.min.js?v=e9d35115" type="text/javascript"></script>
    <script src="//archive.org/includes/build/js/archive.min.js?v=e9d35115" type="text/javascript"></script>
    <!-- navbar styles -->
    <link href="//archive.org/includes/build/css/archive.min.css?v=e9d35115" rel="stylesheet" type="text/css"/>
    <!-- navbar meta -->
    <meta property="mediatype" content="">
    <meta property="primary_collection" content="">
    <!-- navbar end -->
    <script type="text/javascript">if('archive_analytics' in window){var v=archive_analytics.values;v.path='';v.service='wb';v.server_name='wwwb-app219.us.archive.org';v.server_ms=555;archive_analytics.send_pageview_on_load()}</script>
...
<ia-topnav locallinks="true" waybackpagesarchived="__WB_PAGES_ARCHIVED__" class="x-scope ia-topnav-1"><!---->
  ...
  <search-menu class="style-scope ia-topnav x-scope search-menu-1" tabindex="-1"><!---->
    ...
    <div id="close-layer" class="style-scope ia-topnav"></div>
            ...
            <input class="js-tvsearch" type="hidden" value='{"ands":[],"minday":"06/04/2009","maxday":"07/29/2025"}'/>
	...
	<div id="error">
	  <script type="text/javascript">
	    function go() {
	      document.location.href = "/web/20071018051959/http://www.wildlife-pal.org/aspsecured/login.asp";
	    }
	    window.setTimeout(go,  5000);
	  </script>
	  <p class="code">Loading...</p>
	  	  <p class="code shift target">http://www.wildlife-pal.org/ASPSecured/test-page.asp |
	    05:19:59 October 18, 2007</p>
	  <p class="code shift red">Got an HTTP 302 response at crawl time</p>
	  <p class="code">Redirecting to...</p>
	  <p class="code shift target">/aspsecured/login.asp</p>
	  	  <p class="impatient"><a href="/web/20071018051959/http://www.wildlife-pal.org/aspsecured/login.asp">Impatient?</a></p>
	</div>
      </section>
