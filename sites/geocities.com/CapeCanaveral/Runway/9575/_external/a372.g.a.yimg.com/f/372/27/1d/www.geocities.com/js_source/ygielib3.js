...
function yfEA(g){
	...
	if (yfSH()==1&&(top.gg==0||top.gg!=1||!top.gg)){
		yfD();
		document.write('<iframe src="about:blank" height=0 width=0 style="position: absolute; top: 0; left: 0" name="yg_iframe"></iframe>');
		yg_iframe.location=yvContents;
		yfPA();
		window.onresize=yfPA;
		window.onunload=yfCF;
	}
}
function yfID(yvB,yvM,yvT,yvTm){
